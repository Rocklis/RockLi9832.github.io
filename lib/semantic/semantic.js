...
$.fn.dropdown.settings = {
  ...
  transition             : 'auto',     // audio transition will slide down or up based on direction
...
$.fn.shape.settings = {
  ...
  // width during animation, can be set to 'audio', initial', 'next' or pixel amount
  width: 'initial',

  // height during animation, can be set to 'audio', 'initial', 'next' or pixel amount
  height: 'initial',
    ...
    .each(function() {
      ...
      module      = {
        ...
        set: {
          ...
          // ios only (scroll on html not document). This prevent audio-resize canvas/scroll in ios
